        ...
        <div class="container mb-5">
            <div>
                ...
                <p class="indexp mt-3 px-30 text-center">
                    凱茂資訊，能依客戶實際需求規劃最適合的解決方案，如主機虛擬化、郵件伺服器、備份備援、雲端運算、端點管理、網通架構、資訊安全等規劃......
                </p>
            </div>
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 my-5">
                ...
                <div class="col card py-3">
                    ...
                    <div class="card-img-overlay">
                        ...
                        <p class="card-text indexp3 txtIn">
                            凱茂資訊為微軟的雲端服務供應商(CSP),提供Azure、O365、M365、私有雲、混合雲、備份雲的規劃、導入與教育訓練。</p>
                    </div>
                </div>
                <div class="col card py-3">
        ...
        <div class="row col-lg-12 mt-5">
            <div class="col-lg-5">
                <div class="col-lg-10">
                    ...
                    <p class="indexp txtIn">凱茂資訊，能依客戶實際需求規劃最適合的解決方案，如主機虛擬化、郵件伺服器、備份備援、雲端運算、端點管理、網通架構、資訊安全等規劃......。
                    </p>
                </div>
